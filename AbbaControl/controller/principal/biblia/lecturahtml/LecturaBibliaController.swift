...
class LecturaBibliaController: UIViewController, WKNavigationDelegate, OverlayViewDelegateBotonMenos,
...
extension LecturaBibliaController: UIViewControllerTransitioningDelegate {
